...
src_dirs = [
    r"i:\cchlink\data\pieces",
    r"i:\cchlink\data\pieces_board",
    r"i:\cchlink\data\pieces_board_v3",
    r"i:\cchlink\data\pieces_v3",
]
dst = r"i:\cchlink\data\pieces_combined_v3"
...
for src in src_dirs:
    ...
    for c in classes:
        ...
        for f in files:
            ...
            dst_path = os.path.join(dst, c, f"{counters[c]:05d}.png")
