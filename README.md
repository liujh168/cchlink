...
当前 v6 候选融合模式（v4/v5/v6 权重 0.55/0.05/0.40）加近完整初始局模板补全、
视觉占位补全与候选面积先验后，
在固定清单上达到：标准评测 5400/5400 格正确、60/60 盘完全正确；真实照片回归集
1537/1620 格正确（94.88%）、整盘 10/18。wood 子集达到 611/630、整盘 5/7，
initial 子集达到 720/720、整盘 8/8；剩余错误主要转向 plastic midgame、
非初始 wood 与 screen endgame 场景。
